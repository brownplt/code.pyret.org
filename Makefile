...
MISC_IMG = build/web/img/pyret-icon.png build/web/img/pyret-logo.png build/web/img/pyret-spin.gif build/web/img/up-arrow.png build/web/img/down-arrow.png build/web/img/BigLogo.png build/web/img/spyret-break.png build/web/img/spyret-run.png build/web/img/spyret-save.png build/web/img/spyret-share.png build/web/img/spyret-undo.png build/web/img/spyret-redo.png build/web/img/spyret-blank.gif build/web/img/spyret-interactions.png build/web/img/spyret-fadeIcon.png build/web/img/spyret-fadeWords.png build/web/img/spyret-images.gif
