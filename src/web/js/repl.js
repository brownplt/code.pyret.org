...
$(function() {
  ...
  "compiler/compile-structs.arr", "/js/modal-prompt.js"],
  function(replUI, rtLib, guessGas, http, compileLib,
    pyRepl, runtimeLib, replSupport, builtin, cpoBuiltin, gdriveLocators, compileStructs, modalPrompt) {
            ...
            var savedProgram = programToSave.then(function(p) {
              if(p !== null && !copyOnSave) {
                ...
                .then(function(p) {
                  ...
                  setTitle(p.getName());
                  lastSave = editor.cm.getDoc().history.lastModTime;
                  return p;
                })
              }
              else {
