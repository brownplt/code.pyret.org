...
//    ["arity-on-world-callback", "import world as W\nW.big-bang('a', [list: W.on-tick(lam(x, y): x end)])", "defined accepting 2 arguments"],
    ...
    ["satisfies-fail4",                "check: 3 satisfies num-sqr end", [[["test predicate", "must return a boolean", "Instead it returned", "9", "left side"]]]],
    ...
    ["satisfies-because-fail2",        "check: 3 satisfies num-sqr because 6 end", [[["test predicate", "must return a boolean", "Instead it returned", "36", "explanation"]]]],
    ...
    ["raises-fail3",                   "check: num-sqrt(-1) raises 'NumNonNegative' because num-sqrt(4) end", [[["The test was inconsistent", "NumNonNegative", "No exception raised", "explanation", "NumNonNegative"]]]],
    ["raises-fail4",                   "check: num-sqrt(4) raises 'NumNonNegative' because num-sqrt(-1) end", [[["The test operator raises failed", "NumNonNegative", "No exception raised", "left side", "NumNonNegative"]]]],
