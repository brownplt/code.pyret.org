...
//    ["arity-on-world-callback", "import world as W\nW.big-bang('a', [list: W.on-tick(lam(x, y): x end)])", "defined accepting 2 arguments"],
    ...
    ["is-not<=>-pass2",                "check: 3 is-not<=> 4 because 5 end", [[["Passed"]]]],
    ["is-not<=>-fail1",                "check: 3 is-not<=> 3 end", [[["The test operator is-not<=> failed", "left side", "right side", "3"]]]],
    ["is-not<=>-fail2",                "check: 3 is-not<=> 3 because 5 end", [[["The test operator is-not<=> failed", "left side", "right side", "3", "5"]]]],
    ["is-not<=>-fail3",                "check: is-number is-not<=> is-number end", [[["The test operator is-not<=> failed", "two Functions for equality", "left side", "right side", "<function:is-number>", "call them first?"]]]],
    ["is-not<=>-fail4",                "check: ~3 is-not<=> ~4 end", [[["The test operator is-not<=> failed", "two Roughnums for equality", "left side", "right side", "~3", "~4"]]]],
    ["is-not<=>-fail5",                "check: ~3 is-not<=> ~4 because ~4 end", [[["The test was inconsistent", "two Roughnums for equality", "explanation", "right side", "~4", "~4"]]]],
    ["is-not<=>-because-fail1",        "check: 3 is-not<=> 3 because 3 end", [[["The test was inconsistent", "right side", "explanation", "3"]]]],
    ...
    ["satisfies-fail4",                "check: 3 satisfies num-sqr end", [[["test predicate", "must return a boolean", "left side", "num-sqr", "3"]]]],
    ["satisfies-fail5",                "check: 3 satisfies lam(_): 1 / 0 end end", [[["test predicate", "1-argument function that returns a boolean", "<anonymous function>"]]]],
    ["satisfies-fail6",                "check: 3 satisfies lam(_, _): 1 / 0 end end", [[["test predicate", "1-argument function that returns a boolean", "<anonymous function>"]]]],
    ["satisfies-because-fail1",        "check: 3 satisfies is-number because 'hi' end", [[["The test was inconsistent", "predicate", "explanation", "\"hi\""]]]],
    ["satisfies-because-fail2",        "check: 3 satisfies num-sqr because 6 end", [[["test predicate", "must return a boolean", "explanation", "num-sqr", "6"]]]],
    ["satisfies-because-fail3",        "check: 3 satisfies lam(_): 1 / 0 end because 4 end", [[["test predicate", "1-argument function that returns a boolean", "<anonymous function>"]]]],
    ["satisfies-because-fail4",        "check: 3 satisfies lam(_, _): 1 / 0 end because 4 end", [[["test predicate", "1-argument function that returns a boolean", "<anonymous function>"]]]],
    ...
    ["violates-fail5",                 "check: 3 violates lam(_): 1 / 0 end end", [[["test predicate", "1-argument function that returns a boolean", "<anonymous function>"]]]],
    ...
    ["violates-because-fail3",         "check: 3 violates lam(_): 1 / 0 end because 4 end", [[["test predicate", "1-argument function that returns a boolean", "<anonymous function>"]]]],
    ...
    ["raises-fail3",                   "check: num-sqrt(-1) raises 'NumNonNegative' because num-sqrt(4) end", [[["The test was inconsistent", "NumNonNegative", "No exception raised", "explanation", "4"]]]],
    ["raises-fail4",                   "check: num-sqrt(4) raises 'NumNonNegative' because num-sqrt(-1) end", [[["The test operator raises failed", "NumNonNegative", "No exception raised", "left side", "4"]]]],
    ...
    ["raises-satisfies-because-fail3", "check: 3 raises-satisfies num-sqr because 1 / 0 end", [[["1-argument function that returns a boolean", "num-sqr"]]]],
    ...
    ["raises-violates-because-fail3",  "check: 3 raises-violates num-sqr because 1 / 0 end", [[["1-argument function that returns a boolean", "num-sqr"]]]],
